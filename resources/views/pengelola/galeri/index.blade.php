...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="font-heading text-2xl font-bold text-stone-800">Kelola Galeri</h1>
            <p class="text-sm text-stone-500 mt-0.5">Foto dan media Bangkiang Jaran</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
        ...
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden group">
            ...
            <div class="p-4">
                ...
                <div class="flex items-center justify-between mt-3 pt-3 border-t border-stone-100">
                    ...
                    <form method="POST" action="{{ route('pengelola.galeri.destroy', $g->id_galeri) }}" onsubmit="return confirm('Yakin ingin menghapus?')">
                        @csrf
                        @method('DELETE')
        ...
        <div class="col-span-full py-16 text-center">
            ...
            <p class="text-stone-400">Belum ada media</p>
        </div>
        @endforelse
    </div>
