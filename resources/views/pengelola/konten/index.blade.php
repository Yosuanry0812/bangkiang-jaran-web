...
@section('title', __('messages.manage_content_title'))
                    ...
                    <tr class="border-b border-gray-300-100 hover:bg-stone-50 transition-colors">
                        ...
                        <td class="py-3.5 px-4">
                            <div class="flex items-center gap-2">
                                ...
                                <form method="POST" action="{{ route('pengelola.konten.destroy', $k->id_konten) }}" onsubmit="return confirm('{{ __('messages.delete_confirm_msg') }}')">
                                    @csrf
                                    @method('DELETE')
