...
<div class="space-y-6">
    <div>
        <h1 class="font-heading text-2xl font-bold text-stone-800">Laporan</h1>
        <p class="text-sm text-stone-500 mt-0.5">Generate laporan kunjungan dan transaksi</p>
    </div>

    <div class="bg-white rounded-2xl shadow-sm p-6">
        <div class="flex items-center gap-2 mb-5">
            <span class="material-symbols-outlined text-emerald-600">groups</span>
            <h2 class="font-heading text-lg font-semibold text-stone-800">Laporan Kunjungan</h2>
        </div>
        <form method="GET" action="{{ route('pengelola.laporan.kunjungan') }}" class="flex flex-wrap items-end gap-3">
            <div>
                <label class="block text-xs font-semibold uppercase tracking-wider text-stone-500 mb-1.5">Periode Awal</label>
            ...
            <div>
                <label class="block text-xs font-semibold uppercase tracking-wider text-stone-500 mb-1.5">Periode Akhir</label>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6">
        <div class="flex items-center gap-2 mb-5">
            ...
            <h2 class="font-heading text-lg font-semibold text-stone-800">Laporan Transaksi</h2>
        </div>
