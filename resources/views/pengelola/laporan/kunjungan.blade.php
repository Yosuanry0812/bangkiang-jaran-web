...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="font-heading text-2xl font-bold text-gray-500-800">{{ __('messages.visit_report_title') }}</h1>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-300-100 hover:bg-stone-50 transition-colors">
                        ...
                        <td class="py-3.5 px-4 text-gray-500-600">
                            @php
                                $tSum = $k->detailPemesanan->groupBy('nama_tiket')->map(fn($g) => $g->count() . '× ' . $g->first()->nama_tiket)->implode('<br>');
                            @endphp
