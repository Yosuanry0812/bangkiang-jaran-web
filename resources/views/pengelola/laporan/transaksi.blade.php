                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-300-100 hover:bg-stone-50 transition-colors">
                        ...
                        <td class="py-3.5 px-4">
                            @if (($t->pemesanan->kode_booking ?? '') !== '' && str_starts_with($t->pemesanan->kode_booking, 'BJ-OFF-'))
                    ...
                    @empty
                    <tr><td colspan="7" class="py-10 text-center text-gray-500-400">{{ __('messages.no_data_transaction') }}</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
