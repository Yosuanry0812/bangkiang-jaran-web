...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="font-heading text-2xl font-bold text-stone-800">Manajemen User</h1>
            <p class="text-sm text-stone-500 mt-0.5">Daftar pengguna terdaftar</p>
        </div>
    </div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-stone-200 bg-stone-50 text-left">
                        <th class="text-xs font-semibold uppercase tracking-wider text-stone-500 py-3.5 px-4">Nama</th>
                        <th class="text-xs font-semibold uppercase tracking-wider text-stone-500 py-3.5 px-4">Username</th>
                        <th class="text-xs font-semibold uppercase tracking-wider text-stone-500 py-3.5 px-4">Email</th>
                        <th class="text-xs font-semibold uppercase tracking-wider text-stone-500 py-3.5 px-4">No. HP</th>
                        <th class="text-xs font-semibold uppercase tracking-wider text-stone-500 py-3.5 px-4">Tanggal Daftar</th>
                        <th class="text-xs font-semibold uppercase tracking-wider text-stone-500 py-3.5 px-4">Total Pemesanan</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($users ?? [] as $u)
                    ...
                    @empty
                    <tr><td colspan="6" class="py-10 text-center text-stone-400">Tidak ada user</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
